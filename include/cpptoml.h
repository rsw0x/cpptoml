...
#if (defined(CPPTOML_SEPARATE_COMPL) && defined(CPPTOML_IMPL_FILE)) || !defined(CPPTOML_SEPARATE_COMPL)
#define CPPTOML_IS_IMPL 1
#else
#define CPPTOML_IS_IMPL 0
#endif

//Need inline for when there's no intended separate compilation.
#if !defined(CPPTOML_SEPARATE_COMPL)
#define CPPTOML_FN inline
#else
#define CPPTOML_FN 
#endif
...
template <class T>
std::shared_ptr<value<T>> base::as()
{
...
template <class T>
std::shared_ptr<const value<T>> base::as() const
{
...
class array : public base
{
  public:
     ...
     */
    template <class T>
    typename array_of_trait<T>::return_type get_array_of() const
    {
        std::vector<T> result;
...
class table : public base
{
  public:
     ...
     */
    template <class T>
    typename array_of_trait<T>::return_type
...
CPPTOML_FN std::ostream&operator<<(std::ostream& stream, const array& a)
{
    toml_writer writer{stream};
    a.accept(writer);
    return stream;
...
CPPTOML_FN std::ostream&operator<<(std::ostream& stream, const table_array& t)
{
    toml_writer writer{stream};
    t.accept(writer);
    return stream;
...
CPPTOML_FN std::ostream&operator<<(std::ostream& stream, const table& t)
{
    toml_writer writer{stream};
    t.accept(writer);
    return stream;
...
CPPTOML_FN offset_datetime offset_datetime::from_zoned(const tm& t)
{
    offset_datetime dt;
...
CPPTOML_FN offset_datetime offset_datetime::from_local(const tm& t)
{
    return from_zoned(t);
}

CPPTOML_FN offset_datetime offset_datetime::from_utc(const tm& t)
{
    offset_datetime dt;
    dt.year = t.tm_year + 1900;
    dt.month = t.tm_mon + 1;
...
CPPTOML_FN fill_guard::fill_guard(std::ostream& os) : os_(os), fill_{os.fill()}
{
    // nothing
}

CPPTOML_FN fill_guard::~fill_guard()
{
    os_.fill(fill_);
}

CPPTOML_FN std::ostream&operator<<(std::ostream& os, const local_time& ltime)
{
    fill_guard g{os};
    os.fill('0');
...
CPPTOML_FN std::ostream&operator<<(std::ostream& os, const local_date& dt)
{
    fill_guard g{os};
    os.fill('0');
...
CPPTOML_FN std::ostream&operator<<(std::ostream& os, const zone_offset& zo)
{
    fill_guard g{os};
    os.fill('0');
...
CPPTOML_FN std::ostream&operator<<(std::ostream& os, const local_datetime& dt)
{
    return os << static_cast<const local_date&>(dt) << "T"
              << static_cast<const local_time&>(dt);
}

CPPTOML_FN std::ostream&operator<<(std::ostream& os, const offset_datetime& dt)
{
    return os << static_cast<const local_datetime&>(dt)
              << static_cast<const zone_offset&>(dt);
}

CPPTOML_FN bool base::is_value() const
{
    return false;
}

CPPTOML_FN bool base::is_table() const
{
    return false;
}

CPPTOML_FN std::shared_ptr<table> base::as_table()
{
    if (is_table())
...
CPPTOML_FN bool base::is_array() const
{
    return false;
}

CPPTOML_FN std::shared_ptr<array> base::as_array()
{
    if (is_array())
...
CPPTOML_FN bool base::is_table_array() const
{
    return false;
}

CPPTOML_FN std::shared_ptr<table_array> base::as_table_array()
{
    if (is_table_array())
...
CPPTOML_FN base::base()
{
    // nothing
}

CPPTOML_FN array_exception::array_exception(const std::string& err) : std::runtime_error{err}
{
}

CPPTOML_FN bool array::is_array() const
{
    return true;
}

CPPTOML_FN array::iterator array::begin()
{
    return values_.begin();
}

CPPTOML_FN array::const_iterator array::begin() const
{
    return values_.begin();
}

CPPTOML_FN array::iterator array::end()
{
    return values_.end();
}

CPPTOML_FN array::const_iterator array::end() const
{
    return values_.end();
}

CPPTOML_FN std::vector<std::shared_ptr<base> >&array::get()
{
    return values_;
}

CPPTOML_FN const std::vector<std::shared_ptr<base> >&array::get() const
{
    return values_;
}

CPPTOML_FN std::shared_ptr<base> array::at(size_t idx) const
{
    return values_.at(idx);
}

CPPTOML_FN std::vector<std::shared_ptr<array> > array::nested_array() const
{
...
CPPTOML_FN void array::push_back(const std::shared_ptr<array>& val)
{
...
CPPTOML_FN array::iterator array::insert(array::iterator position, const std::shared_ptr<array>& value)
{
    if (values_.empty() || values_[0]->is_array())
    {
        return values_.insert(position, value);
...
CPPTOML_FN array::iterator array::erase(array::iterator position)
{
    return values_.erase(position);
}

CPPTOML_FN void array::clear()
{
    values_.clear();
}

CPPTOML_FN std::shared_ptr<array> make_array()
{
...
CPPTOML_FN table_array::iterator table_array::begin()
{
    return array_.begin();
}

CPPTOML_FN table_array::const_iterator table_array::begin() const
{
    return array_.begin();
}

CPPTOML_FN table_array::iterator table_array::end()
{
    return array_.end();
}

CPPTOML_FN table_array::const_iterator table_array::end() const
{
    return array_.end();
}

CPPTOML_FN bool table_array::is_table_array() const
{
    return true;
}

CPPTOML_FN std::vector<std::shared_ptr<table> >&table_array::get()
{
    return array_;
}

CPPTOML_FN const std::vector<std::shared_ptr<table> >&table_array::get() const
{
    return array_;
}

CPPTOML_FN void table_array::push_back(const std::shared_ptr<table>& val)
{
    array_.push_back(val);
}

CPPTOML_FN table_array::iterator table_array::insert(table_array::iterator position, const std::shared_ptr<table>& value)
{
    return array_.insert(position, value);
}

CPPTOML_FN table_array::iterator table_array::erase(table_array::iterator position)
{
    return array_.erase(position);
}

CPPTOML_FN void table_array::clear()
{
    array_.clear();
}

CPPTOML_FN table_array::table_array()
{
    // nothing
}

CPPTOML_FN std::shared_ptr<table_array> make_table_array()
{
...
CPPTOML_FN table::iterator table::begin()
{
    return map_.begin();
}

CPPTOML_FN table::const_iterator table::begin() const
{
    return map_.begin();
}

CPPTOML_FN table::iterator table::end()
{
    return map_.end();
}

CPPTOML_FN table::const_iterator table::end() const
{
    return map_.end();
}

CPPTOML_FN bool table::is_table() const
{
    return true;
}

CPPTOML_FN bool table::empty() const
{
    return map_.empty();
}

CPPTOML_FN bool table::contains(const std::string& key) const
{
    return map_.find(key) != map_.end();
}

CPPTOML_FN bool table::contains_qualified(const std::string& key) const
{
    return resolve_qualified(key);
}

CPPTOML_FN std::shared_ptr<base> table::get(const std::string& key) const
{
    return map_.at(key);
}

CPPTOML_FN std::shared_ptr<base> table::get_qualified(const std::string& key) const
{
...
CPPTOML_FN std::shared_ptr<table> table::get_table(const std::string& key) const
{
...
CPPTOML_FN std::shared_ptr<table> table::get_table_qualified(const std::string& key) const
{
...
CPPTOML_FN std::shared_ptr<array> table::get_array(const std::string& key) const
{
    if (!contains(key))
        return nullptr;
...
CPPTOML_FN std::shared_ptr<array> table::get_array_qualified(const std::string& key) const
{
...
CPPTOML_FN std::shared_ptr<table_array> table::get_table_array(const std::string& key) const
{
    if (!contains(key))
        return nullptr;
...
CPPTOML_FN std::shared_ptr<table_array> table::get_table_array_qualified(const std::string& key) const
{
    if (!contains_qualified(key))
        return nullptr;
...
CPPTOML_FN void table::insert(const std::string& key, const std::shared_ptr<base>& value)
{
    map_[key] = value;
}

CPPTOML_FN void table::erase(const std::string& key)
{
    map_.erase(key);
}

CPPTOML_FN table::table()
{
    // nothing
}

CPPTOML_FN std::vector<std::string> table::split(const std::string& value, char separator) const
{
...
CPPTOML_FN bool table::resolve_qualified(const std::string& key, std::shared_ptr<base>* p) const
{
...
CPPTOML_FN std::shared_ptr<table> make_table()
{
...
CPPTOML_FN  parse_exception::parse_exception(const std::string& err) : std::runtime_error{err}
{
}

parse_exception::parse_exception(const std::string& err, std::size_t line_number)
: std::runtime_error{err + " at line " + std::to_string(line_number)}
{
}

CPPTOML_FN parser::parser(std::istream& stream) : input_(stream)
{
}

CPPTOML_FN std::shared_ptr<table> parser::parse()
{
...
CPPTOML_FN void parser::throw_parse_exception(const std::string& err)
{
    throw parse_exception{err, line_number_};
}

CPPTOML_FN void parser::parse_table(std::string::iterator& it, const std::string::iterator& end, table*& curr_table)
{
...
CPPTOML_FN void parser::parse_single_table(std::string::iterator& it, const std::string::iterator& end, table*& curr_table)
{
    if (it == end || *it == ']')
...
CPPTOML_FN void parser::parse_table_array(std::string::iterator& it, const std::string::iterator& end, table*& curr_table)
{
    ++it;
    if (it == end || *it == ']')
...
CPPTOML_FN void parser::parse_key_value(std::string::iterator& it, std::string::iterator& end, table* curr_table)
{
...
CPPTOML_FN std::string parser::parse_bare_key(std::string::iterator& it, const std::string::iterator& end)
{
    if (it == end)
    {
...
CPPTOML_FN std::string parser::parse_quoted_key(std::string::iterator& it, const std::string::iterator& end)
{
    return string_literal(it, end, '"');
}

CPPTOML_FN std::shared_ptr<base> parser::parse_value(std::string::iterator& it, std::string::iterator& end)
{
...
CPPTOML_FN parser::parse_type parser::determine_value_type(const std::string::iterator& it, const std::string::iterator& end)
{
    if (*it == '"' || *it == '\'')
    {
...
CPPTOML_FN parser::parse_type parser::determine_number_type(const std::string::iterator& it, const std::string::iterator& end)
{
...
CPPTOML_FN std::shared_ptr<value<std::string> > parser::parse_string(std::string::iterator& it, std::string::iterator& end)
{
    auto delim = *it;
    assert(delim == '"' || delim == '\'');
...
CPPTOML_FN std::shared_ptr<value<std::string> > parser::parse_multiline_string(std::string::iterator& it, std::string::iterator& end, char delim)
{
    std::stringstream ss;
...
CPPTOML_FN std::string parser::string_literal(std::string::iterator& it, const std::string::iterator& end, char delim)
{
    ++it;
    std::string val;
    while (it != end)
...
CPPTOML_FN std::string parser::parse_escape_code(std::string::iterator& it, const std::string::iterator& end)
{
    ++it;
    if (it == end)
...
CPPTOML_FN std::string parser::parse_unicode(std::string::iterator& it, const std::string::iterator& end)
{
    bool large = *it++ == 'U';
...
CPPTOML_FN uint32_t parser::parse_hex(std::string::iterator& it, const std::string::iterator& end, uint32_t place)
{
    uint32_t value = 0;
    while (place > 0)
    {
...
CPPTOML_FN bool parser::is_hex(char c)
{
    return is_number(c) || (c >= 'a' && c <= 'f') || (c >= 'A' && c <= 'F');
}

CPPTOML_FN uint32_t parser::hex_to_digit(char c)
{
    if (is_number(c))
...
CPPTOML_FN std::shared_ptr<base> parser::parse_number(std::string::iterator& it, const std::string::iterator& end)
{
    auto check_it = it;
...
CPPTOML_FN std::shared_ptr<value<int64_t> > parser::parse_int(std::string::iterator& it, const std::string::iterator& end)
{
    std::string v{it, end};
...
CPPTOML_FN std::shared_ptr<value<double> > parser::parse_float(std::string::iterator& it, const std::string::iterator& end)
{
    std::string v{it, end};
    v.erase(std::remove(v.begin(), v.end(), '_'), v.end());
    it = end;
...
CPPTOML_FN std::shared_ptr<value<bool> > parser::parse_bool(std::string::iterator& it, const std::string::iterator& end)
{
...
CPPTOML_FN std::string::iterator parser::find_end_of_number(std::string::iterator it, std::string::iterator end)
{
...
CPPTOML_FN std::string::iterator parser::find_end_of_date(std::string::iterator it, std::string::iterator end)
{
    return std::find_if(it, end, [this](char c) {
...
CPPTOML_FN std::string::iterator parser::find_end_of_time(std::string::iterator it, std::string::iterator end)
{
    return std::find_if(it, end, [this](char c) {
...
CPPTOML_FN local_time parser::read_time(std::string::iterator& it, const std::string::iterator& end)
{
...
CPPTOML_FN std::shared_ptr<value<local_time> > parser::parse_time(std::string::iterator& it, const std::string::iterator& end)
{
    return make_value(read_time(it, end));
}

CPPTOML_FN std::shared_ptr<base> parser::parse_date(std::string::iterator& it, const std::string::iterator& end)
{
...
CPPTOML_FN std::shared_ptr<base> parser::parse_array(std::string::iterator& it, std::string::iterator& end)
{
...
CPPTOML_FN std::shared_ptr<table> parser::parse_inline_table(std::string::iterator& it, std::string::iterator& end)
{
    auto tbl = make_table();
    do
    {
...
CPPTOML_FN void parser::skip_whitespace_and_comments(std::string::iterator& start, std::string::iterator& end)
{
...
CPPTOML_FN void parser::consume_whitespace(std::string::iterator& it, const std::string::iterator& end)
{
    while (it != end && (*it == ' ' || *it == '\t'))
        ++it;
}

CPPTOML_FN void parser::consume_backwards_whitespace(std::string::iterator& back, const std::string::iterator& front)
{
    while (back != front && (*back == ' ' || *back == '\t'))
        --back;
}

CPPTOML_FN void parser::eol_or_comment(const std::string::iterator& it, const std::string::iterator& end)
{
    if (it != end && *it != '#')
...
CPPTOML_FN bool parser::is_time(const std::string::iterator& it, const std::string::iterator& end)
{
    auto time_end = find_end_of_time(it, end);
...
CPPTOML_FN option<parser::parse_type> parser::date_type(const std::string::iterator& it, const std::string::iterator& end)
{
    auto date_end = find_end_of_date(it, end);
...
CPPTOML_FN std::shared_ptr<table> parse_file(const std::string& filename)
{
...
CPPTOML_FN toml_writer::toml_writer(std::ostream& s, const std::string& indent_space)
: stream_(s), indent_(indent_space), has_naked_endline_(false)
{
    // nothing
}

CPPTOML_FN void toml_writer::visit(const table& t, bool in_array)
{
...
CPPTOML_FN void toml_writer::visit(const array& a, bool)
{
    write("[");
...
CPPTOML_FN void toml_writer::visit(const table_array& t, bool)
{
...
CPPTOML_FN std::string toml_writer::escape_string(const std::string& str)
{
    std::string res;
...
CPPTOML_FN void toml_writer::write(const value<std::string>& v)
{
    write("\"");
...
CPPTOML_FN void toml_writer::write(const value<double>& v)
{
...
CPPTOML_FN void toml_writer::write(const value<bool>& v)
{
    write((v.get() ? "true" : "false"));
}

CPPTOML_FN void toml_writer::write_table_header(bool in_array)
{
    if (!path_.empty())
    {
        indent();
...
CPPTOML_FN void toml_writer::write_table_item_header(const base& b)
{
...
CPPTOML_FN void toml_writer::indent()
{
    for (std::size_t i = 1; i < path_.size(); ++i)
        write(indent_);
}

CPPTOML_FN void toml_writer::endline()
{
...
CPPTOML_FN std::ostream&operator<<(std::ostream& stream, const base& b)
{
    toml_writer writer{stream};
    b.accept(writer);
    return stream;
...
template <>
CPPTOML_FN std::shared_ptr<value<double>> base::as()
{
...
template <>
CPPTOML_FN std::shared_ptr<const value<double>> base::as() const
{
    if (auto v
...
template <>
CPPTOML_FN std::shared_ptr<array> make_element<array>()
{
    return make_array();
}
...
template <>
typename array_of_trait<array>::return_type
CPPTOML_FN array::get_array_of<array>() const
{
...
template <>
CPPTOML_FN std::shared_ptr<table_array> make_element<table_array>()
{
...
template <>
typename array_of_trait<array>::return_type
CPPTOML_FN table::get_array_of<array>(const std::string& key) const
{
    if (auto v = get_array(key))
    {
        std::vector<std::shared_ptr<array>> result;
...
template <>
typename array_of_trait<array>::return_type
CPPTOML_FN table::get_qualified_array_of<array>(const std::string& key) const
{
    if (auto v = get_array(key))
    {
        std::vector<std::shared_ptr<array>> result;
...
template <>
CPPTOML_FN std::shared_ptr<table> make_element<table>()
{
    return make_table();
}

CPPTOML_FN bool is_number(char c)
{
    return c >= '0' && c <= '9';
}
}
